              ...
              <div className="overflow-x-auto border border-slate-400 dark:border-slate-800 rounded-xl flex-1 shadow-sm">
                <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                  <thead className="bg-slate-100/60 dark:bg-slate-950/50">
                    <tr>
                      <th className="px-4 py-3 text-left text-[10px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest w-1/5">Contact Name</th>
                      <th className="px-4 py-3 text-left text-[10px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest w-1/5">Account Name</th>
                      <th className="px-4 py-3 text-left text-[10px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest w-1/5">Action Completed</th>
                      <th className="px-4 py-3 text-left text-[10px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest w-1/5">Action Taken</th>
                      <th className="px-4 py-3 text-left text-[10px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest w-1/5">Future Reminder</th>
                    ...
                    {todayActions.length === 0 ? (
                      ...
                      todayActions.map((action, idx) => (
                        <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-950/30 transition-colors border-b border-slate-300 dark:border-slate-800/50 last:border-0">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-xs text-slate-700 dark:text-slate-400 font-medium w-1/5 truncate max-w-xs">{action.actionTaken}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-xs text-slate-700 font-medium w-1/5">{action.reminderDate || '-'}</td>
