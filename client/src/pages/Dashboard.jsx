                ...
                <table className="min-w-full divide-y divide-slate-150 dark:divide-slate-800">
                  <thead className="bg-slate-50/60 dark:bg-slate-950/50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-right text-[10px] font-bold text-slate-600 dark:text-slate-700 uppercase tracking-widest">Actions</th>
                    </tr>
                  </thead>
                ...
                <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                  <thead className="bg-slate-100/60 dark:bg-slate-950/50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-right text-[10px] font-bold text-slate-600 dark:text-slate-700 uppercase tracking-widest"></th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-150 dark:divide-slate-800 text-sm">
